...
func (t *Task) Progress() (label string, done, total int64) {
	t.state.reading()
	if t.progress == nil {
...
func (t *Task) SetProgress(label string, done, total int64) {
...
// Cleans all the log messages of the task
func (t *Task) CleanLog() {
	t.state.writing()
	t.log = []string{}
}
